...
# NOTE(Friso): I absolutely dispise everything in this file.
# If I get the chance to refactor it I will.
# But for now it's just adding some cruft on top of what's here.
...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False):
    ...
    def __func_clean_up(gpt_response, prompt=""):
        time = gpt_response.upper()
        for marker in ["AM", "PM"]:
            if marker in time:
                time = time[:time.index(marker) + 2].strip()
        for fmt in ["%I:%M %p", "%I %p"]:
            return datetime.datetime.strptime(time, fmt).hour
        cr = int(time.strip().split("AM")[0])
        return cr
    ...
    prompt_template = "persona/prompt_template/v4/wake_up_hour_v2.txt"
...
def run_gpt_prompt_daily_plan(persona,
    ...
    def __func_clean_up(gpt_response, prompt=""):
        ...
        if not all(isinstance(x, str) for x in result):
            raise ValueError("Daily plan must be strings")
        return result
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "medium", "max_tokens": 8196,
                 "temperature": 1, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/daily_planning_v7.txt"
...
def run_gpt_prompt_generate_hourly_schedule(persona,
    ...
    def create_prompt_input(persona,
        ...
        prompt_ending = f"What  {persona.scratch.get_str_firstname()} be doing at [(ID:{get_random_alphanumeric()})"
        prompt_ending += f" {persona.scratch.get_str_curr_date_str()}"
        prompt_ending += f" -- {curr_hour_str}]?"
        prompt_ending += f" Complete the sentence: {persona.scratch.get_str_firstname()} is."
        prompt_ending += f" Respond with a JSON object with the following structure"
        prompt_ending += " {\"output\": \"<ACTIVITY >\"}."
        prompt_ending += f" Do not include the {persona.scratch.get_str_firstname()} is in the output, only the activity."
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 8196,
                 ...
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
    prompt_template = "persona/prompt_template/v4/generate_hourly_schedule_v2.txt"
    prompt_input = create_prompt_input(persona,
                                       curr_hour_str,
                                       p_f_ds_hourly_org,
                                       hour_str,
...
def run_gpt_prompt_task_decomp(persona,
    ...
    def __func_clean_up(gpt_response, prompt=""):
        ...
        _cr = json.loads(gpt_response)
        cr = []
        for cr_subtask in _cr:
            val = [cr_subtask['task'], int(cr_subtask['duration_in_minutes'])]
            cr.append(val)
...
def run_gpt_prompt_action_sector(action_description,
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 4096,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/action_location_sector_v3.txt"
    prompt_input = create_prompt_input(action_description, persona, maze)
    prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_action_arena(action_description,
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 4096,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/action_location_object_v2.txt"
...
def run_gpt_prompt_action_game_object(action_description,
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 16,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/action_object_v3.txt"
...
def run_gpt_prompt_pronunciatio(action_description, persona, verbose=False):
    ...
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
    # prompt_template = "persona/prompt_template/v4/generate_pronunciatio_v1.txt"
    # prompt_input = create_prompt_input(action_description)
...
def run_gpt_prompt_event_triple(action_description, persona, verbose=False):
    ...
    def __func_clean_up(gpt_response, prompt=""):
        response = json.loads(gpt_response)
        cr = [response["subject"], response["predicate"], response["object"]]
        return cr
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 30,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
    prompt_template = "persona/prompt_template/v4/generate_event_triple_v2.txt"
    prompt_input = create_prompt_input(action_description, persona)
    prompt = generate_prompt(prompt_input, prompt_template)
    fail_safe = get_fail_safe(persona)
    output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
...
def run_gpt_prompt_act_obj_desc(act_game_object, act_desp, persona, verbose=False):
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 1024,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/generate_obj_event_v2.txt"
    ...
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
    # prompt_template = "persona/prompt_template/v4/generate_obj_event_v1.txt"
    # prompt_input = create_prompt_input(act_game_object, act_desp, persona)
    # prompt = generate_prompt(prompt_input, prompt_template)
    # fail_safe = get_fail_safe(act_game_object)
    # output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
...
def run_gpt_prompt_create_conversation(persona, target_persona, curr_loc,
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 1000,
                 ...
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/create_conversation_v2.txt"
...
def run_gpt_prompt_summarize_conversation(persona, conversation, test_input=None, verbose=False):
    ...
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = "persona/prompt_template/v4/summarize_conversation_v1.txt"
    # prompt_input = create_prompt_input(conversation, test_input)
    # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_extract_keywords(persona, description, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 50,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/get_keywords_v1.txt"
...
def run_gpt_prompt_keyword_to_thoughts(persona, keyword, concept_summary, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 40,
                 "temperature": 0.7, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/keyword_to_thoughts_v1.txt"
...
def run_gpt_prompt_convo_to_thoughts(persona,
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 40,
                 "temperature": 0.7, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/convo_to_thoughts_v1.txt"
...
def run_gpt_prompt_event_poignancy(persona, event_description, test_input=None, verbose=False):
    ...
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = "persona/prompt_template/v4/poignancy_event_v1.txt"
    # prompt_input = create_prompt_input(persona, event_description)
    # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_thought_poignancy(persona, event_description, test_input=None, verbose=False):
    ...
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = "persona/prompt_template/v4/poignancy_thought_v1.txt"
    # prompt_input = create_prompt_input(persona, event_description)
    # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_chat_poignancy(persona, event_description, test_input=None, verbose=False):
    ...
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = "persona/prompt_template/v4/poignancy_chat_v1.txt"
    # prompt_input = create_prompt_input(persona, event_description)
    # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_agent_chat_summarize_ideas(persona, target_persona, statements, curr_context, test_input=None, verbose=False):
    ...
    #              "temperature": 0.5, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = "persona/prompt_template/v4/summarize_chat_ideas_v1.txt"
...
def run_gpt_prompt_agent_chat_summarize_relationship(persona, target_persona, statements, test_input=None, verbose=False):
    ...
    #              "temperature": 0.5, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = "persona/prompt_template/v4/summarize_chat_relationship_v1.txt"
    # prompt_input = create_prompt_input(persona, target_persona, statements)
    # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_agent_chat(maze, persona, target_persona,
    ...
    # gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low","max_tokens": 2000,
    #              "temperature": 0.7, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = "persona/prompt_template/v4/agent_chat_v1.txt"
...
def run_gpt_prompt_summarize_ideas(persona, statements, question, test_input=None, verbose=False):
    ...
    #              "temperature": 0.5, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = "persona/prompt_template/v4/summarize_ideas_v1.txt"
    # prompt_input = create_prompt_input(persona, statements, question)
    # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_generate_next_convo_line(persona, interlocutor_desc, prev_convo, retrieved_summary, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 250,
                 "temperature": 1, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/generate_next_convo_line_v1.txt"
    prompt_input = create_prompt_input(
...
def run_gpt_prompt_generate_whisper_inner_thought(persona, whisper, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 50,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/whisper_inner_thought_v1.txt"
...
def run_gpt_prompt_memo_on_convo(persona, all_utt, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-5-nano", "reasoning_effort": "low", "max_tokens": 50,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = "persona/prompt_template/v4/memo_on_convo_v1.txt"
    prompt_input = create_prompt_input(persona, all_utt)
    prompt = generate_prompt(prompt_input, prompt_template)
