...
def GPT4_request(prompt):
    ...
    raise Exception("I'm not looking to spend gpt-4 money")
...
def GPT_request(prompt, gpt_parameter):
    ...
    """
    temp_sleep()
    if gpt_parameter["max_tokens"] < 1024:
        gpt_parameter["max_tokens"] = 1024
        print("max_tokens was set below 16")
    try:
